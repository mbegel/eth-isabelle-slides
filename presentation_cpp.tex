...
\begin{frame}{Termination of smart contracts}
	\begin{itemize}
		...
		\item<2-> Every execution ends up in a terminating state:
		\begin{itemize}
			\item To invoke a contract, a gas budget is provided
			\item EVM deducts a specified amount of gas for execution of each instruction
			\item Hence any contract eventually reaches $\ncont$: 
